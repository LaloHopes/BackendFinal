  ...
  try {
      ...
      res.status(200).json({
          ...
          user: { 
              ...
              name: updatedUser.name, // Suponiendo que el campo es "name" y no "user"
              email: updatedUser.email, 
              edad: updatedUser.edad, 
              idrol: updatedUser.idrol // Se incluye para redirección basada en el rol
          },
          rememberToken: updatedUser.remember_token // Retorna el remember_token
      });
